    ...
    while True:
        ...
        if isinstance(frame, bytes):
            ...
            if last_pts is None or frame.pts != last_pts:
                ...
                box_img = fall_detector.test_process_frame_box(cv2.resize(img.copy(), (half_w, half_h)))
                pose_img = fall_detector.test_process_frame_pose_fall(cv2.resize(img.copy(), (half_w, half_h)))
